...
/*if(isset($_POST['submit'])){
  ...
  $query = "SELECT * FROM medium_test WHERE `id` = $id1";
  $result = mysqli_query($conn,$query);
  $row = mysqli_fetch_array($result);

  $query2 = "SELECT * FROM medium_test WHERE `id` = $id2";
  $result = mysqli_query($conn,$query2);
  $row2 = mysqli_fetch_array($result);

  $query3 = "SELECT * FROM medium_test WHERE `id` = $id3";
  $result = mysqli_query($conn,$query3);
  $row3 = mysqli_fetch_array($result);

  $query4 = "SELECT * FROM medium_test_texat WHERE `id` = $id4";
  $result = mysqli_query($conn,$query4);
  $row4 = mysqli_fetch_array($result);

  $query5 = "SELECT * FROM medium_test_tf WHERE `id` = $id5";
...
$sql10 = "INSERT INTO `testhistory` (`username`,`testdate`,`level`,`result`) VALUES ('$username','$date','2','$counter') ";

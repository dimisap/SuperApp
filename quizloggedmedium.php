<?php 
  ...
  $query = "SELECT count(*) FROM `medium_test`";
  ...
  $query2 = "SELECT count(*) FROM `medium_test_tf`";
  ...
  $query3 = "SELECT count(*) FROM `medium_test_texat`";
  ...
  if(isset($_SESSION['username'])){
    ...
    $sql = "SELECT * FROM `medium_test` where `id` = '$q1'";
    $result = mysqli_query($conn,$sql);
    $row1 = mysqli_fetch_array($result);

    $sql2 = "SELECT * FROM `medium_test` where `id` = '$q2'";
    $result = mysqli_query($conn,$sql2);
    $row2 = mysqli_fetch_array($result);

    $sql3 = "SELECT * FROM `medium_test` where `id` = '$q3'";
    $result = mysqli_query($conn,$sql3);
    $row3 = mysqli_fetch_array($result);

    $sql4 = "SELECT * FROM `medium_test_texat` where `id` = '$q4'";
    $result = mysqli_query($conn,$sql4);
    $row4 = mysqli_fetch_array($result);

    $sql5 = "SELECT * FROM `medium_test_tf` where `id` = '$q5'";
...
<?php if(isset($_SESSION['username'])):?>    
    <div class="topnav" id="myTopnav">
      ...
      <h3>Try yourself</h3>
      <h4> Level : Medium</h4>
      <a href="quizloggedmedium.php"><button type="button" class="btn btn-primary" >Αλλαγή κουιζ</button></a>
      <br><br>
      <div class="row">
      ...
      <div class="form ">
        <form name="quiz" id="quiz" method="POST" action="resultsmed.php">

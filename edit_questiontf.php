<?php
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM `add_question_tf` WHERE `id` = '$id'";
    ...
    if(isset($_POST['submit'])){
        ...
        if($level == 1){
            $row['level'] = 1;
            $sql = "INSERT INTO `easy_test_tf` (`question`,`True1`,`False1`,`correct`) VALUES ('$question','$true','$false','$correct')";
            $sql2 = "DELETE FROM `add_question_tf` WHERE `id` = '$id'";
        }else if($level == 2){
            $row['level'] = 2;
            $sql = "INSERT INTO `medium_test_tf` (`question`,`True1`,`False1`,`correct`) VALUES ('$question','$true','$false','$correct')";
            $sql2 = "DELETE FROM `add_question_tf` WHERE `id` = '$id'";
        }else{
            $row['level'] = 3;
            $sql = "INSERT INTO `difficult_test_tf` (`question`,`True1`,`False1`,`correct`) VALUES ('$question','$true','$false','$correct')";
            $sql2 = "DELETE FROM `add_question_tf` WHERE `id` = '$id'";
        }       
	...
	<div class="row">
      ...
      <div class="col-9 col-md-9  personal-info">
        ...
        <form class="form-horizontal" role="form" method = "POST" >
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label">True </label>
            <div class="col-lg-8">
              
              <textarea class="form-control" name ="true" rows="3"><?php echo $row['True1']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">False</label>
            <div class="col-lg-8">
              
              <textarea class="form-control" name ="false" rows="3"><?php echo $row['False1']?></textarea>
            </div>
          </div>

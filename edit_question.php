<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($level == 1){
            $row['level'] = 1;
            $sql = "INSERT INTO `easy_test` (`question`,`answer1`,`answer2`,`answer3`,`answer4`,`correct`) VALUES ('$question','$answer1','$answer2','$answer3','$correct','$correct')";
            $sql2 = "DELETE FROM `add_question` WHERE `id` = '$id'";
        }else if($level == 2){
            $row['level'] = 2;
            $sql = "INSERT INTO `medium_test` (`question`,`answer1`,`answer2`,`answer3`,`answer4`,`correct`) VALUES ('$question','$answer1','$answer2','$answer3','$correct','$correct')";
            $sql2 = "DELETE FROM `add_question` WHERE `id` = '$id'";
        }else{
            $row['level'] = 3;
            $sql = "INSERT INTO `difficult_test` (`question`,`answer1`,`answer2`,`answer3`,`answer4`,`correct`) VALUES ('$question','$answer1','$answer2','$answer3','$correct','$correct')";
            $sql2 = "DELETE FROM `add_question` WHERE `id` = '$id'";
        }       
        ...
        <form class="form-horizontal" role="form" method = "POST" >
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              ...
              <textarea class="form-control" name ="answer1" rows="3"><?php echo $row['answer1']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Answer 2:</label>
            <div class="col-lg-8">
              
              <textarea class="form-control" name ="answer2" rows="3"><?php echo $row['answer2']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Answer 3:</label>
            <div class="col-lg-8">
             
              <textarea class="form-control" name ="answer3" rows="3"><?php echo $row['answer3']?></textarea>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Correct :</label>
            <div class="col-lg-8">
             
              <textarea class="form-control" name ="correct" rows="3"><?php echo $row['correct']?></textarea>
            </div>
          </div>
          <div class="form-group">
